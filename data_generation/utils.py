...
def get_customer_segmentation_data(num_samples=1000):
    ...
    clus1 = pd.DataFrame(
        {
            "Customer_ID": np.arange(1, int(num_samples/3) + 1),
            "Age": rand.randint(60, 70, size=int(num_samples/3)), #old
            "Gender": rand.choice(["M", "F"], size=int(num_samples/3), p=[0.5, 0.5]),
            "CreditScore": rand.randint(750, 850, size=int(num_samples/3)), #high credit score
            "Tenure": rand.randint(9, 10, size=int(num_samples/3)), # long tenure
            "Balance": rand.uniform(190000, 200000, size=int(num_samples/3)),#large
            "Education": rand.randint(6, 7, size=int(num_samples/3)), #very educated
            "HasTravelCard": rand.choice([0, 1], size=int(num_samples/3), p=[0.1, 0.9]), # has cc
            "HasCashBackCard": rand.choice([0, 1], size=int(num_samples/3), p=[0.5, 0.5]),
            "HasPointsCard": rand.choice([0, 1], size=int(num_samples/3), p=[0.1, 0.9]),
            "HasRewardsCard": rand.choice([0, 1], size=int(num_samples/3), p=[0.5, 0.5]),
            "HasSecuredCard": rand.choice([0, 1], size=int(num_samples/3), p=[0.5, 0.5]),
            "Transaction_Count": rand.randint(4, 5, size=int(num_samples/3)),
            "Avg_Transaction_Value": rand.uniform(400, 500, size=int(num_samples/3)),
            "EstimatedSalary": rand.uniform(140000, 150000, size=int(num_samples/3)) #high
        }
    )

    clus2 = pd.DataFrame(
        {
            "Customer_ID": np.arange(int(num_samples/3) + 1, 2*int(num_samples/3) + 1),
            "Age": rand.randint(40, 55, size=int(num_samples/3)), #middle aged
            "Gender": rand.choice(["M", "F"], size=int(num_samples/3), p=[0.5, 0.5]), #women
            "CreditScore": rand.randint(800, 850, size=int(num_samples/3)), #high credit score
            "Tenure": rand.randint(5, 7, size=int(num_samples/3)), #mid-long tenure
            "Balance": rand.uniform(100000, 150000, size=int(num_samples/3)), #middle range
            "Education": rand.randint(4, 5, size=int(num_samples/3)),
            # "Country": rand.choice(items, size=num_samples), #across all countries
            "HasTravelCard": rand.choice([0, 1], size=int(num_samples/3), p=[0.5, 0.5]), # has cc
            "HasCashBackCard": rand.choice([0, 1], size=int(num_samples/3), p=[0.5, 0.5]),
            "HasPointsCard": rand.choice([0, 1], size=int(num_samples/3), p=[0.5, 0.5]),
            "HasRewardsCard": rand.choice([0, 1], size=int(num_samples/3), p=[0.1, 0.9]),
            "HasSecuredCard": rand.choice([0, 1], size=int(num_samples/3), p=[0.5, 0.5]),
            "Transaction_Count": rand.randint(4, 5, size=int(num_samples/3)), #lots of transaction
            "Avg_Transaction_Value": rand.uniform(100, 200, size=int(num_samples/3)),#middle range transactions
            "EstimatedSalary": rand.uniform(100000, 150000, size=int(num_samples/3)) #middle range salary
        }
    )

    clus3 = pd.DataFrame(
        {
            "Customer_ID": np.arange(2*int(num_samples/3) + 1, 3*int(num_samples/3) + 2),
            "Age": rand.randint(18, 25, size=int(num_samples/3)+1),#young
            "Gender": rand.choice(["M", "F"], int(num_samples/3)+1), #men & women
            "CreditScore": rand.randint(300, 400, size=int(num_samples/3)+1), #low
            "Tenure": rand.randint(0, 2, size=int(num_samples/3)+1), #short
            "Balance": rand.uniform(0, 10000, size=int(num_samples/3)+1), #low
            "Education": rand.randint(1, 3, size=int(num_samples/3)+1),
            # "Country": rand.choice(items, size=num_samples),#all
            "HasTravelCard": rand.choice([0, 1], size=int(num_samples/3)+1, p=[0.5, 0.5]), # has cc
            "HasCashBackCard": rand.choice([0, 1], size=int(num_samples/3)+1, p=[0.1, 0.9]),
            "HasPointsCard": rand.choice([0, 1], size=int(num_samples/3)+1, p=[0.5, 0.5]),
            "HasRewardsCard": rand.choice([0, 1], size=int(num_samples/3)+1, p=[0.5, 0.5]),
            "HasSecuredCard": rand.choice([0, 1], size=int(num_samples/3)+1, p=[0.5, 0.5]),
            "Transaction_Count": rand.randint(1, 2, size=int(num_samples/3)+1), #few
            "Avg_Transaction_Value": rand.uniform(20, 50, size=int(num_samples/3)+1), #low
            "EstimatedSalary": rand.uniform(20000, 50000, size=int(num_samples/3)+1)
        }
    )
